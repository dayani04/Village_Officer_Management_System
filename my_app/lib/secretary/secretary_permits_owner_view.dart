...
class SecretaryPermitsOwnerViewPage extends StatefulWidget {
  final String villagerId;
  const SecretaryPermitsOwnerViewPage({Key? key, required this.villagerId})
    : super(key: key);

  @override
  State<SecretaryPermitsOwnerViewPage> createState() =>
      _SecretaryPermitsOwnerViewPageState();
}

class _SecretaryPermitsOwnerViewPageState
    extends State<SecretaryPermitsOwnerViewPage> {
  ...
  void handleBack() {
    Navigator.pushNamed(context, '/secretary_permits_owner');
  }
