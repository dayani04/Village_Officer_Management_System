...
class SecretaryAllowanceApplicationsPage extends StatefulWidget {
  const SecretaryAllowanceApplicationsPage({Key? key}) : super(key: key);

  @override
  State<SecretaryAllowanceApplicationsPage> createState() =>
      _SecretaryAllowanceApplicationsPageState();
}

class _SecretaryAllowanceApplicationsPageState
    extends State<SecretaryAllowanceApplicationsPage> {
  bool _loading = true;
  String? _error;
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _error = response.statusCode == 401
              ...
              : 'Failed to fetch applications: ${response.body}';
          _loading = false;
        });
  ...
  void handleStatusChange(
    ...
    setState(() {
      statusUpdates['$villagerId-$allowancesId'] = newStatus;
    });
  }
  ...
  Future<void> handleSend(
    ...
    final newStatus = statusUpdates['$villagerId-$allowancesId'];
  ...
  void handleViewDetails(String villagerId) {
    ...
    Navigator.pushNamed(
      context,
      '/secretary_allowance_applications_villager_view',
