...
class _SecretaryPermitApplicationsPageState
  ...
  Future<void> fetchApplications() async {
    ...
    try {
      ...
      debugPrint('DEBUG: Fetch permit applications response: ${response.statusCode} ${response.body}');
      if (response.statusCode == 200) {
        ...
        setState(() {
          error = response.statusCode == 401
              ...
              : 'Failed to fetch permit applications: ${response.body}';
          loading = false;
        });
      ...
      debugPrint('DEBUG: Fetch permit applications error: $e');
      setState(() {
        error = 'Error: $e';
        loading = false;
      });
  ...
  void handleStatusChange(String villagerId, String permitsId, String newStatus) {
    setState(() {
  ...
  Future<void> handleSend(
    ...
    try {
      ...
      debugPrint('DEBUG: Update permit status response: ${statusRes.statusCode} ${statusRes.body}');
      ...
      debugPrint('DEBUG: Send permit notification response: ${notifRes.statusCode} ${notifRes.body}');
      ...
      debugPrint('DEBUG: Handle permit send error: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
  ...
  Future<void> handleDownload(String filename) async {
    ...
    try {
      ...
      debugPrint('DEBUG: Download permit error: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
