...
class SecretaryPermitApplicationsVillagerViewPage extends StatefulWidget {
  final String villagerId;
  const SecretaryPermitApplicationsVillagerViewPage({
    Key? key,
    required this.villagerId,
  }) : super(key: key);

  @override
  State<SecretaryPermitApplicationsVillagerViewPage> createState() =>
      _SecretaryPermitApplicationsVillagerViewPageState();
}

class _SecretaryPermitApplicationsVillagerViewPageState
    extends State<SecretaryPermitApplicationsVillagerViewPage> {
  ...
  void handleBack() {
    Navigator.pushNamed(context, '/secretary_permit_applications');
  }
              ...
              child: Container(
                ...
                child: loading
                    ...
                    ? Column(
                        ...
                        children: [
                          const Text(
                            'Permit Application Villager Details',
                            style: TextStyle(
                              fontSize: 24,
                              fontWeight: FontWeight.bold,
