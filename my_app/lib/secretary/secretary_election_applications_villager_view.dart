...
class SecretaryElectionApplicationsVillagerView extends StatefulWidget {
  ...
  @override
  State<SecretaryElectionApplicationsVillagerView> createState() =>
      _SecretaryElectionApplicationsVillagerViewState();
}

class _SecretaryElectionApplicationsVillagerViewState
    extends State<SecretaryElectionApplicationsVillagerView> {
              ...
              child: Container(
                ...
                child: loading
                    ...
                    ? Column(
                        ...
                        children: [
                          const Text(
                            'Election Application Villager Details',
                            style: TextStyle(
                              fontSize: 24,
