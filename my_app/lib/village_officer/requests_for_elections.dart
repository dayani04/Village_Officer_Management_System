...
class RequestsForElectionsPage extends StatefulWidget {
  @override
  _RequestsForElectionsPageState createState() =>
      _RequestsForElectionsPageState();
}

class _RequestsForElectionsPageState extends State<RequestsForElectionsPage> {
  ...
  void viewDetails(String villagerId) {
    Navigator.pushNamed(
      context,
      '/requests_for_elections_villager_details',
                  ...
                  rows: applications.map((app) {
                    ...
                    return DataRow(
                      cells: [
                        ...
                        DataCell(Text(app['Election_Type'] ?? '')),
                        DataCell(
                          Text(
                            app['apply_date'] != null
