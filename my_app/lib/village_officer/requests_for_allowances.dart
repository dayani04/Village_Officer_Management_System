...
class RequestsForAllowancesPage extends StatefulWidget {
  @override
  _RequestsForAllowancesPageState createState() =>
      _RequestsForAllowancesPageState();
}

class _RequestsForAllowancesPageState extends State<RequestsForAllowancesPage> {
  ...
  void viewDetails(String villagerId) {
    Navigator.pushNamed(
      context,
      '/requests_for_allowances_villager_details',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Allowance Applications')),
      body: Row(
        children: [
              ...
              child: SingleChildScrollView(
                ...
                child: DataTable(
                  ...
                  rows: applications.map((app) {
                    final key = '${app['Villager_ID']}-${app['Allowances_ID']}';
                    return DataRow(
                      cells: [
                        DataCell(Text(app['Full_Name'] ?? '')),
                        DataCell(Text(app['Villager_ID'].toString())),
                        DataCell(Text(app['Allowances_Type'] ?? '')),
                        DataCell(
                          Text(
                            app['apply_date'] != null
