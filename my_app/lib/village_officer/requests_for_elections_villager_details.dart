...
class RequestsForElectionsVillagerDetailsPage extends StatefulWidget {
  @override
  _RequestsForElectionsVillagerDetailsPageState createState() =>
      _RequestsForElectionsVillagerDetailsPageState();
}

class _RequestsForElectionsVillagerDetailsPageState
    extends State<RequestsForElectionsVillagerDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Row(
        children: [
          VillageOfficerSidebar(selectedIndex: 2, selectedSubIndex: 4),
          Expanded(
            child: Container(
              ...
              child: Padding(
                ...
                child: ListView(
                  children: [
                    ...
                    SizedBox(height: 20),
                    ElevatedButton(
                      child: Text('Back to Election Applications'),
