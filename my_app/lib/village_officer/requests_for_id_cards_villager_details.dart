...
class RequestsForIDCardsVillagerDetailsPage extends StatefulWidget {
  @override
  _RequestsForIDCardsVillagerDetailsPageState createState() =>
      _RequestsForIDCardsVillagerDetailsPageState();
}

class _RequestsForIDCardsVillagerDetailsPageState
    extends State<RequestsForIDCardsVillagerDetailsPage> {
              ...
              child: Padding(
                ...
                child: ListView(
                  children: [
                    ...
                    SizedBox(height: 20),
                    ElevatedButton(
                      child: Text('Back to NIC Applications'),
