...
import './RequestsForIDCardsVillagerDetails.css';

const RequestsForIDCardsVillagerDetails = () => {
  ...
  const handleBack = () => {
    navigate('/requests-for-id-cards');
  };
...
export default RequestsForIDCardsVillagerDetails;