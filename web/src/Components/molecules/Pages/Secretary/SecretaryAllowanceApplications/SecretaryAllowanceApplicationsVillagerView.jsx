...
const SecretaryAllowanceApplicationsVillagerView = () => {
  const { id } = useParams();
  ...
  const handleBack = () => {
    navigate('/secretary_allowance_applications');
  };
  ...
  return (
    <section className="view-villager-page">
      <button className="view-villager-back-btn" onClick={handleBack}>
        ...
        <h1>Allowance Applicant Details</h1>
...
export default SecretaryAllowanceApplicationsVillagerView;