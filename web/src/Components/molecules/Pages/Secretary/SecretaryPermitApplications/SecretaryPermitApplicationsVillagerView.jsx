...
import './SecretaryPermitApplicationsVillagerView.css';

const SecretaryPermitApplicationsVillagerView = () => {
  const { id } = useParams();
  ...
  const handleBack = () => {
    navigate('/secretary_permit_applications');
  };
  ...
  return (
    <section className="view-villager-page">
      <button className="view-villager-back-btn" onClick={handleBack}>
        ...
        <h1>Permit Applicant Details</h1>
...
export default SecretaryPermitApplicationsVillagerView;