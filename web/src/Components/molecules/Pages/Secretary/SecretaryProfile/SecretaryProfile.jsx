...
import { getProfile, updateSecretary, requestPasswordOtp, verifyPasswordOtp } from "../../../../../api/secretary";
...
const SecretaryProfile = () => {
  ...
  const handleEditSubmit = async (e) => {
    e.preventDefault();
    try {
      await updateSecretary(profile.Secretary_ID, formData);
  ...
  const handlePasswordSubmit = async (e) => {
    e.preventDefault();
    try {
      await verifyPasswordOtp(secretaryId, passwordForm.otp, passwordForm.newPassword);
